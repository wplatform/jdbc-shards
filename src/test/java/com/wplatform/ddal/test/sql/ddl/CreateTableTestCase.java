...
public class CreateTableTestCase extends BaseTestCase {
    ...
    public static final String CONSTRAINT_PARENT_SQL = "CREATE TABLE  %s (   `col1 int not null` int(11) NOT NULL,   `col2` int(11) DEFAULT NULL,   `col3` varchar(20) DEFAULT NULL,   `col4` varchar(200) DEFAULT NULL,   `col5` int(1) DEFAULT 0,   CONSTRAINT PRIMARY KEY (`col1`),   CONSTRAINT UNIQUE KEY (`col2`),   KEY USING BTREE (`col3`),   CHECK (`col5` IN (1,2,3,4,5))  ) ENGINE=InnoDB DEFAULT CHARSET=latin1";
    public static final String CONSTRAINT_CHILD_SQL = "CREATE TABLE  %s (   `col1` int(11) NOT NULL,   `col2` int(11) NOT NULL,   `col3` varchar(200) DEFAULT NULL,   `col4` datetime NOT NULL,   `col5` int(1) DEFAULT 0,   CONSTRAINT PRIMARY KEY (`col1`),   CONSTRAINT UNIQUE KEY (`col2`),   CONSTRAINT `orders_fk` FOREIGN KEY (`col3`) REFERENCES `constraint_test_parent` (`col4`)   KEY USING BTREE (`col4`),   CHECK (`col5` IN (1,2,3,4,5)) ) ENGINE=InnoDB DEFAULT CHARSET=latin1";
