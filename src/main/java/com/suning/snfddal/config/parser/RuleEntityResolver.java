...
public class RuleEntityResolver implements EntityResolver {
    ...
    private static final String MAPPER_DOCTYPE = "-//suning.com//DTD ddal-rule//EN"
            .toUpperCase(Locale.ENGLISH);

    private static final String SNF_DAL_MAPPER_URL = "http://suning.com/dtd/ddal-rule.dtd"
            .toUpperCase(Locale.ENGLISH);
