...
public class ConfigEntityResolver implements EntityResolver {
    ...
    private static final String MAPPER_DOCTYPE = "-//suning.com//DTD ddal-config//EN"
            .toUpperCase(Locale.ENGLISH);

    private static final String SNF_DAL_MAPPER_URL = "http://suning.com/dtd/ddal-config.dtd"
            .toUpperCase(Locale.ENGLISH);
