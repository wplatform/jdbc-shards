 ...
 */
package com.wplatform.ddal.shards.vendor;
...
import com.wplatform.ddal.shards.ExceptionSorter;
...
public class OracleExceptionSorter implements ExceptionSorter, Serializable {
    ...
    public boolean isExceptionFatal(final SQLException e) {
        ...
        switch (error_code) {
            ...
            case 1035: // ORACLE only available to users with RESTRICTED SESSION
                // privilege
            case 1089: // immediate shutdown in progress - no operations are
                // permitted
            case 1090: // shutdown in progress - connection is not permitted
            case 1092: // ORACLE instance terminated. Disconnection forced
            case 1094: // ALTER DATABASE CLOSE in progress. Connections not
                // permitted
            ...
            case 3134: // Connections to this server version are no longer
                // supported.
            ...
            case 3142: // Connection was lost for the specified session and serial
                // number. This is either due to session
                // being killed or network problems.
            case 3143: // Connection was lost for the specified process ID and
                // thread ID. This is either due to session
                // being killed or network problems.
            case 3144: // Connection was lost for the specified process ID. This is
                // either due to session being killed
                // or network problems.
            case 3145: // I/O streaming direction error
            case 3149: // Invalid Oracle error code, Cause: An invalid Oracle error
                // code was received by the server.

            case 6801: // TLI Driver: listen for SPX server reconnect failed
            case 6802: // TLI Driver: could not open the /etc/netware/yellowpages
                // file
            ...
            case 25409: // failover happened during the network operation,cannot
                // continue
